...
{
    // Velocit� di movimento del giocatore
    ...
    // Flag per controllare se il giocatore pu� muoversi
    [HideInInspector]
    ...
    void Start()
    {
        ...
        // Verifica se il componente Rigidbody2D � stato ottenuto correttamente
        ...
        // Verifica se il componente Animator � stato ottenuto correttamente
    ...
    private void Update()
    {
        // Controlla se il giocatore pu� muoversi
        if (!canMove)
            return;
        ...
        if (PlayerInput != Vector2.zero)
        {
            ...
            // Imposta la velocit� del Rigidbody2D e aggiorna i parametri dell'Animator
